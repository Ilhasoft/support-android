...
/**
 * Created by john-mac on 4/21/16.
 */
public class MediaPicker {
    ...
    public File pickImageFromCamera(Fragment fragment) throws IOException {
        ...
        if (takePictureIntent.resolveActivity(fragment.getActivity().getPackageManager()) != null) {
            br.com.ilhasoft.support.tool.bitmap.IOManager ioManager = new br.com.ilhasoft.support.tool.bitmap.IOManager(fragment.getActivity());
